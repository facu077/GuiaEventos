    ...
    describe('Notificaciones Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/notificaciones';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Notificaciones', () => {

                let entity: Notificaciones;
                service.find(123).subscribe((_entity: Notificaciones) => {
                    entity = _entity;
                });
