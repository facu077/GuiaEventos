...
@Component({
    selector: 'jhi-evento-registrado',
    templateUrl: './evento-registrado.component.html'
})
export class EventoRegistradoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.eventoService.queryRegistrado({
            page: this.page,
