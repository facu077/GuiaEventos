    ...
    loadAll() {
        if (this.currentSearch) {
            ...
            /*this.eventos.forEach((element) => {
                // element = this.eventoService.find(element.id);
                this.eventoService.find(element.id).subscribe((evento) => {
                    element = evento;
                });
            });*/
            ...
            /*for (let i = 0; i < this.eventos.length; i++) {
                ...
                this.eventoService.find(this.eventos[i].id).subscribe((evento) => {
